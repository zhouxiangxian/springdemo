...
public class TestAOP {
	...
	public void getGetInfo() {
		...
		Logger.getLogger(TestAOP.class).info(bean.getInfo());
	...
	public void testDeptConstructor() {
		...
		Logger.getLogger(TestAOP.class).info(emp);
	}
	...
	public void testDeptXiaoXianConstructor() {
		...
		Logger.getLogger(TestAOP.class).info(dept);
	}
	...
	public void testAnnotation() {
		...
		Logger.getLogger(TestAOP.class).info(deptService.add(vo));
	}
}
